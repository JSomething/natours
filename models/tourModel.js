...
//used to specifcy schema (description, validation)
...
// coords should be indexed to a 2d sphere, an "earth-like sphere"
...
//Middleware for embedded guides in the tour
...
// ^ means all strings that start with find
tourSchema.pre(/^find/, function (next) {
